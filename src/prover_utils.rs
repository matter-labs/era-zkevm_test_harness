...
use snark_wrapper::boojum::field::SmallField;
...
pub fn prove_recursion_layer_circuit<POW: PoWRunner>(
    ...
    let builder_impl = CsReferenceImplementationBuilder::<GoldilocksField, P, ProvingCSConfig, crate::boojum::dag::StCircuitResolver<GoldilocksField, <ProvingCSConfig as CSConfig>::ResolverConfig>>::new(
        geometry,
        max_trace_len.unwrap(),
    );
    let builder = new_builder::<_, GoldilocksField>(builder_impl);
