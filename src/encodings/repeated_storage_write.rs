...
impl<F: SmallField> OutOfCircuitFixedLengthEncodable<E, 2> for RepeatedStorageWrite {
...
impl<F: SmallField> CircuitEquivalentReflection<E> for RepeatedStorageWrite {
