...
fn main() {
    ...
    function.line(format!("cycles_per_events_or_l1_messages_sorter: {},", opt.events_or_l1_messages_sorter));
    ...
    function.line(format!("cycles_per_code_decommitter: {},", opt.code_decommitter));
    function.line(format!("cycles_per_storage_application: {},", opt.storage_application));
    function.line(format!("limit_for_initial_writes_pubdata_hasher: {},", opt.initial_writes));
    function.line(format!("limit_for_repeated_writes_pubdata_hasher: {},", opt.repeated_writes));
