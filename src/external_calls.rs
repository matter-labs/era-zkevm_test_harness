...
>(
    ...
    let (scheduler_circuit_witness, aux_data) = {
        ...
        let [keccak256_observable_output, sha256_observable_output, ecrecover_observable_output, secp256r1_verify_observable_output, fri_proof_verify_observable_output] =
            outputs;
        ...
        let scheduler_circuit_witness = SchedulerCircuitInstanceWitness {
            ...
            fri_proof_verify_observable_output,
