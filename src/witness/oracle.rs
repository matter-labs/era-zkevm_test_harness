...
>(
    ...
    memory_artifacts_for_main_vm.decommittment_queue_entry_states.extend(decommittment_queue_states.into_iter().map(|el| (el.0, transform_sponge_like_queue_state(el.1))));
