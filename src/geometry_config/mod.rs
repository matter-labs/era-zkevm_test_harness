...
pub const fn get_geometry_config() -> GeometryConfig {
    GeometryConfig {
        cycles_per_vm_snapshot: 2818,
        cycles_code_decommitter_sorter: 71247,
        cycles_per_log_demuxer: 55156,
        cycles_per_storage_sorter: 25436,
        cycles_per_events_or_l1_messages_sorter: 11750,
        cycles_per_ram_permutation: 72733,
        cycles_per_code_decommitter: 2845,
        cycles_per_storage_application: 31,
