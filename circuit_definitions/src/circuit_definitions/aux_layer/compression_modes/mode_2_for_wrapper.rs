...
impl ProofCompressionFunction for CompressionMode2ForWrapper {
    ...
    type ThisLayerHasher = Poseidon2Sponge<Bn256, F, AbsorptionModeReplacement<Fr>, 2, 3>;
    type ThisLayerTranscript = Poseidon2Transcript<Bn256, F, AbsorptionModeReplacement<Fr>, 2, 3>;
