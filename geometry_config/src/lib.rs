//! Geometry config contains the information about the circuit capacity.
//! That is, how many steps/cycles we are doing in each cycle.
//! The concrete values are auto-generated by the tool (geometry_config_generator).
use derivative::Derivative;
mod autogenerated;

/// Gets the current geometry config.
pub use autogenerated::get_geometry_config;
